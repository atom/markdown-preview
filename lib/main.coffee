...
module.exports =
  config:
    breakOnSingleNewline:
      type: 'boolean'
      default: false
      description: 'In Markdown, a single newline character doesn\'t cause a line break in the generated HTML. In GitHub Flavored Markdow, that is not true. Enable this config option to insert line breaks in redenred HTML for single newlines in Markdown source.'
    liveUpdate:
      type: 'boolean'
      default: true
